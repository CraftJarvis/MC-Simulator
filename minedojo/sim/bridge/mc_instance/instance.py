...
OFFLINE_MC_DIR = os.path.join(
    os.path.dirname(os.path.dirname(os.path.dirname(__file__))),
    "mc", 
    "Minecraft",
)
OFFLINE_SCHEMAS_DIR = os.path.join(
    os.path.dirname(os.path.dirname(os.path.dirname(__file__))),
    "mc",
    "Schemas",
)
...
class MinecraftInstance:
    ...
    def _launch_minecraft(self, port, minecraft_dir, replaceable=True):
        ...
        """
        print(">>>>>> Launching a Malmo instance with online mode <<<<<<")
    ...
    def _launch_offline_minecraft(self, port, minecraft_dir, replaceable=True):
        """Launch Minecraft listening for malmoenv connections.
        Args:
            port:  the TCP port to listen on.
            installdir: the install dir name. Defaults to MalmoPlatform.
        ...
        Asserts:
            that the port specified is open.
        """
        print(">>>>>> Launching a Malmo instance with offline mode <<<<<<")
